            ...
            {!formFile || !isValidFile() ? (
                <>
                    ...
                    <div className="flex flex-col gap-1 mt-1">
                        {formFile && !isValidExtension() && <Text className="text-accent-red" variant="label-small">
                            Tipo de arquivo inválido!
                        </Text>}
                        {formFile && !isValidSize() && <Text className="text-accent-red" variant="label-small">
                            Tamanho do arquivo não suportado!
                        </Text>}
                        {error && <Text className="text-accent-red" variant="label-small">
                            {error}
                        </Text>}
                    </div>
                </>
